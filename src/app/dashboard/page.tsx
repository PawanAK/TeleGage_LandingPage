  ...
  return (
    <div className="bg-black text-white min-h-screen bg-[linear-gradient(to_bottom,#000,#200D42_34%,#4F21A1_65%,#A45EDB_82%)]">
      ...
      <div className="flex pt-16">
        <aside className={`bg-gray-800 w-64 fixed h-full transition-transform duration-300 ease-in-out transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0`}>
          <nav className="p-4">
            <ul className="space-y-2">
              <li>
                <a href="#" className="block py-2 px-4 text-white hover:bg-gray-700 rounded">Dashboard</a>
              </li>
              <li>
                <a href="#" className="block py-2 px-4 text-white hover:bg-gray-700 rounded">Communities</a>
              </li>
              <li>
                <a href="#" className="block py-2 px-4 text-white hover:bg-gray-700 rounded">Messages</a>
              </li>
              <li>
                <a href="#" className="block py-2 px-4 text-white hover:bg-gray-700 rounded">NFTs</a>
              </li>
              <li>
                <a href="#" className="block py-2 px-4 text-white hover:bg-gray-700 rounded">Settings</a>
              </li>
            </ul>
          </nav>
        </aside>
